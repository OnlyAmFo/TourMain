  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex h-screen pt-16 lg:pt-0">
        ...
        <AnimatePresence mode="wait">
          {(isMobileMenuOpen || window.innerWidth >= 1024) && (
            <motion.div
              ...
              className={`fixed lg:static inset-y-0 left-0 z-40 w-[280px] bg-white dark:bg-gray-800 shadow-lg lg:shadow-none border-r border-gray-200 dark:border-gray-700 transform lg:transform-none ${
                isMobileMenuOpen
                  ? "translate-x-0"
                  : "-translate-x-full lg:translate-x-0"
              } overflow-y-auto lg:block pt-16 lg:pt-0`}
            >
              <div className="flex flex-col h-full">
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center space-x-3 px-4 py-3 mb-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
                    <div className="flex-shrink-0">
                      <div className="h-10 w-10 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center">
                        <FaUsers className="h-5 w-5 text-emerald-600 dark:text-emerald-400" />
                      </div>
                    </div>
        ...
        {/* Main Content */}
        <div className="flex-1 lg:ml-[280px] overflow-x-hidden">
