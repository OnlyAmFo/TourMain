      ...
      <div className="flex justify-between items-center">
        ...
        <div className="relative">
          <input
            ...
            className="pl-10 pr-4 py-2 border border-gray-300 bg-white text-gray-900 placeholder:text-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
          />
